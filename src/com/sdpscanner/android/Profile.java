...
public class Profile {
  ...
  public static HashSet<Integer> A2dpProfileServices =
      new HashSet<Integer>(
          Arrays.asList(AudioSourceService, AudioSinkService, AdvancedAudioDistributionService));
  public static HashSet<Integer> AvrcpProfileServices =
      new HashSet<Integer>(
          Arrays.asList(AudioVideoRemoteControlTargetService, AudioVideoRemoteControlService));
  public static HashSet<Integer> BipProfileServices =
      new HashSet<Integer>(
          Arrays.asList(
              ImagingService,
              ImagingResponderService,
              ImagingAutomaticArchiveService,
              ImagingReferencedObjectsService));
  public static HashSet<Integer> BppProfileServices =
      new HashSet<Integer>(
          Arrays.asList(
              DirectPrintingService,
              DirectPrintingService,
              DirectPrintingReferenceObjectsService,
              ReflectedUIService,
              BasicPrintingService,
              PrintingStatusService));
  ...
  public static HashSet<Integer> PbapProfileServices =
      new HashSet<Integer>(
          Arrays.asList(
              PhonebookAccessService, PhonebookAccessPSEService, PhonebookAccessPCEService));
  ...
  public static HashSet<Integer> VdpProfileServices =
      new HashSet<Integer>(
          Arrays.asList(VideoSourceService, VideoSinkService, VideoDistributionService));
  private int mName;
