...
public class ProfileAdapter extends BaseAdapter {
  ...
  public ProfileAdapter(
      Context context, ArrayList<Profile> profiles, ArrayList<Parcelable> unknowServices) {
    mContext = context;
  ...
  public View getView(int position, View convertView, ViewGroup parent) {
    ...
    Log.d(
        TAG, "layout children count before: " + ((ViewGroup) holder.linearLayout).getChildCount());
