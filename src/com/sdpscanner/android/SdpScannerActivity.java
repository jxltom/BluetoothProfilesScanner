...
public class SdpScannerActivity extends Activity {
  ...
  public static final String PICKER_SELECTED =
  ...
  private final BroadcastReceiver mPickerReceiver =
  ...
  private final BroadcastReceiver mUuidReceiver =
      new BroadcastReceiver() {
        @Override
        public void onReceive(Context context, Intent intent) {
            ...
            if (uuids != null) {
              for (Parcelable uuid : uuids) {
                ...
                if (service != Profile.UnknowService) {
                  ...
                  if (!(uuid.toString().equals(BluetoothAllUuid.BASE_UUID.toString()))
                      && !UnknowServices.contains(uuid)) {
              ...
              createDialog(
                      ...
                      "Please turn on remote device's bluetooth\n WARGING: Some device may not respond to sdp command.")
                  .show();
            }
          }
        }
  ...
  */
  ...
  private void handleDiscoveredServics() {
    ...
    Profile[] tmp = {
      mA2DP, mAVRCP, mBIP, mBPP, mDUN, mFTP, mHFP, mHSP, mMAP, mOPP, mPBAP, mPAN, mSAP, mSPP,
      mSYNCP, mVDP, mOTHERS
    };
